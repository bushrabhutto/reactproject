        ...
        <section class="pt-24 pb-8">
            <div class="container">
                    ...
                    <div class="col-12 col-lg-7 mb-16 mb-lg-0">
                        <div class="row">
                            ...
                            <div class="col-6 col-md-3 mb-16 mb-md-0">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-4"><a class="btn btn-link p-0 text-secondary" href="#" >Login</a></li>
                            ...
                            <div class="col-6 col-md-3">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-4"><a class="btn btn-link p-0 text-secondary" href="#" >Terms</a></li>
                                    <li class="mb-4"><a class="btn btn-link p-0 text-secondary" href="#" >About Us</a></li>
                            ...
                            <div class="col-6 col-md-3">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-4"><a class="btn btn-link p-0 text-secondary" href="#" >Blog</a></li>
                    ...
                    <div class="col-12 col-lg-5">
                        ...
                        <form action="#">
                            <div class="input-group mw-md bg-white">
                                <input class="form-control" type="email" placeholder="Type your e-mail" />
                ...
                <div class="position-relative d-sm-flex align-items-center justify-content-between text-center">
                    <p class="d-none d-md-block position-absolute top-50 start-50 translate-middle fs-9 text-secondary mb-0" >Copyright &copy; 2022 Flaro. All Rights Reserved</p><a class="d-inline-block mb-8 mb-sm-0" href="#"><img class="img-fluid" src="flaro-assets/logos/flaro-logo-black.svg" alt="" width="auto" /></a>
